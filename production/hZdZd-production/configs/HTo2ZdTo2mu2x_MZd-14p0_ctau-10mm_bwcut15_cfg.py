...
# with command line options: Configuration/GenProduction/python/HTo2ZdTo2mu2x_MZd-14p0_ctau-10mm_TuneCP5_13p6TeV_pythia8_cff.py --python_filename HTo2ZdTo2mu2x_MZd-14p0_ctau-10mm_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:output_gensim.root --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(59) --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n 200
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HTo2ZdTo2mu2x_MZd-14p0_ctau-10mm_TuneCP5_13p6TeV_pythia8_cff.py nevts:200'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '1023:isResonance = on',
            '1023:mayDecay = on',
            '1023:oneChannel = 1  0.20421 100 -2 2',
            '1023:addChannel = 1  0.20407 100 -4 4',
            '1023:addChannel = 1  0.144 100 -13 13',
            '1023:addChannel = 1  0.144 100 -11 11',
            '1023:addChannel = 1  0.15172 100 -15 15',
            '1023:addChannel = 1  0.052262 100 -3 3',
            '1023:addChannel = 1  0.052262 100 1 -1',
            '1023:addChannel = 1  0.047445 100 -5 5',
            '1023:addChannel = 1  1.828e-05 100 16 -16',
            '1023:addChannel = 1  1.828e-05 100 14 -14',
            '1023:addChannel = 1  1.828e-05 100 12 -12'
        ),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    #args = cms.vstring('/ceph/cms/store/user/fernance/Run3ScoutingProduction/hZdZd/Gridpacks_v2/LL_HAHM_MS_400_kappa_0p01_MZd_14p0_ctau_10_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
    args = cms.vstring('/ceph/cms/store/user/fernance/EXO-24-016/Gridpack-test/LL_HAHM_MS_400_kappa_0p01_MZd_14_ctau_10_bwcut15_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(59)
