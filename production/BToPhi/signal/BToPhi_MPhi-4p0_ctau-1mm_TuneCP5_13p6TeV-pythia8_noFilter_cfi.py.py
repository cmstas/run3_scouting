...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Generic BBbar with a long-lived scalar resonance, m=4.0 GeV, ctau=1 mm'),
    name = cms.untracked.string('$Generic BBbar with a long-lived scalar resonance, m=4.0 GeV, ctau=1 mm$'),
