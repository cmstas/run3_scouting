...
# with command line options: Configuration/GenProduction/python/EXO-Run3Summer22GS-00780-fragment.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3 --python_filename EXO-Run3Summer22GS-00780_1_cfg.py --fileout file:EXO-Run3Summer22GS-00780.root --number 43478 --number_out 100 --no_exec --mc
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(43478),
