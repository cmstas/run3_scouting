...
# with command line options: Configuration/GenProduction/python/EXO-Run3Summer22GS-00780-fragment.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3_2023 --python_filename EXO-Run3Summer22GS-00780_1_cfg.py --fileout file:EXO-Run3Summer22GS-00780.root --number 41666 --number_out 100 --no_exec --mc
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(41666),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Generic BBbar with a long-lived scalar resonance, m=1.25 GeV, ctau=1000 mm'),
    name = cms.untracked.string('$Generic BBbar with a long-lived scalar resonance, m=1.25 GeV, ctau=1000 mm$'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-Run3Summer22GS-00780.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '6000211:all = GeneralResonance void 0 0 0 1.25 0.001 0.0 0.0 1000',
            '6000211:mayDecay = true',
