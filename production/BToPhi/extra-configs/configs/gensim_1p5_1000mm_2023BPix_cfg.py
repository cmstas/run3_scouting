...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Generic BBbar with a long-lived scalar resonance, m=1.5 GeV, ctau=1000 mm'),
    name = cms.untracked.string('$Generic BBbar with a long-lived scalar resonance, m=1.5 GeV, ctau=1000 mm$'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '6000211:all = GeneralResonance void 0 0 0 1.5 0.001 0.0 0.0 1000',
