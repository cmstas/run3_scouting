...
# with command line options: Configuration/GenProduction/python/EXO-Run3Summer22EEGS-00706-fragment.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step GEN,SIM --geometry DB:Extended --era Run3 --python_filename EXO-Run3Summer22EEGS-00706_1_cfg.py --fileout file:EXO-Run3Summer22EEGS-00706.root --number 43478 --number_out 100 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Generic BBbar with a long-lived scalar resonance, m=5.0 GeV, ctau=100 mm'),
    name = cms.untracked.string('$Generic BBbar with a long-lived scalar resonance, m=5.0 GeV, ctau=100 mm$'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-Run3Summer22EEGS-00706.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentGeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '6000211:all = GeneralResonance void 0 0 0 4.6 0.001 0.0 0.0 100',
