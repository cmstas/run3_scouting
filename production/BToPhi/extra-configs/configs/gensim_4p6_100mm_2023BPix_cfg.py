...
# with command line options: Configuration/GenProduction/python/EXO-Run3Summer23BPixGS-00315-fragment.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 130X_mcRun3_2023_realistic_postBPix_v6 --beamspot Realistic25ns13p6TeVEarly2023Collision --step GEN,SIM --geometry DB:Extended --era Run3_2023 --python_filename EXO-Run3Summer23BPixGS-00315_1_cfg.py --fileout file:EXO-Run3Summer23BPixGS-00315.root --number 41666 --number_out 100 --no_exec --mc
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-Run3Summer23BPixGS-00315.root'),
