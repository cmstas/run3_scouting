...
usage()
{
    echo "Usage:"
    echo ""
    echo "  sh condor/runScoutingLooper_Signal2024_onCondor.sh ['notar'] output_tag"
    echo ""
    echo "  output_tag : a label for the output directory, e.g. looperOutput_22Jul_Signal"
...
condor_submit condor/runScoutingLooper_Signal2024_onCondor.sub